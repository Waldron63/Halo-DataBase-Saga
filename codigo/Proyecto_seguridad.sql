CREATE OR REPLACE PACKAGE PA_CLIENTES AS
    ...
    PROCEDURE nuevo_personaje(v_nombreUsuario VARCHAR2,v_nombreCampaña VARCHAR2,v_nombre VARCHAR2, v_juego VARCHAR2, v_descripcion VARCHAR2, v_desaparecidos CHAR, v_rol VARCHAR2, v_tiposInfectados VARCHAR2, v_rango VARCHAR2, v_especieAlien VARCHAR2);   
    ...
    PROCEDURE mejorar_covenant(v_nombreUsuario VARCHAR2,v_nombre VARCHAR2,v_rango VARCHAR2,v_herejes CHAR,v_armadura NUMBER,v_juego VARCHAR2,v_descripcion VARCHAR2,v_rol VARCHAR2,v_desaparecidos CHAR);
    --actualiza los datos del personaje en humanos--
    PROCEDURE mejorar_humano(v_nombreUsuario VARCHAR2,v_nombreHumano VARCHAR2,v_rango VARCHAR2,v_juego VARCHAR2,v_descripcion VARCHAR2,v_rol VARCHAR2,v_desaparecidos CHAR);
   PROCEDURE generar_mapa(v_nombreUsuario VARCHAR2,v_nombrePersonaje VARCHAR2,v_nombre VARCHAR2,v_descripcion VARCHAR2,v_juego VARCHAR2,v_lugar VARCHAR2,v_bioma VARCHAR2);
    ...
    PROCEDURE recargar_mapa(v_nombreUsuario VARCHAR2,v_nombre VARCHAR2,v_descripcion VARCHAR2,v_juego VARCHAR2,v_lugar VARCHAR2,v_bioma VARCHAR2);
    --elimina los mapas--
    ...
    PROCEDURE obtener_granada(V_NOMBREuSUARIO varchar2,v_nombreGranada VARCHAR2, v_descripcion VARCHAR2, v_alcance NUMBER, v_daño NUMBER, v_acumulado NUMBER);
    ...
    PROCEDURE potenciar_granada(v_nombreUsuario varchar2,v_nombreGranada VARCHAR2, v_descripcion VARCHAR2, v_alcance NUMBER, v_daño NUMBER, v_acumulado NUMBER);
    PROCEDURE usar_potenciador(v_nombreUsuario varchar2,v_nombrePotenciador VARCHAR2, v_descripcion VARCHAR2, v_grupo CHAR, v_durabilidad NUMBER);
    ...
    PROCEDURE mejorar_potenciador(v_nombreUsuario VARCHAR2,v_nombrePotenciador VARCHAR2, v_descripcion VARCHAR2, v_durabilidad NUMBER);
    --procedimiento que elimina los potenciadores--
     PROCEDURE recolectar_arma(v_nombreUsuario VARCHAR2,v_idMunicion VARCHAR2,v_nombreArma VARCHAR2, v_tipoArma VARCHAR2, v_definicion VARCHAR2, v_juego VARCHAR2, v_grupo CHAR, v_daño NUMBER, v_nombreGranada VARCHAR2, v_nombrePotenciador VARCHAR2, v_nombrePersonaje VARCHAR2);
    ...
    PROCEDURE potenciar_arma(v_nombreUsuario varchar2,v_nombreArma VARCHAR2, v_definicion VARCHAR2, v_juego VARCHAR2, v_daño NUMBER, v_manejo VARCHAR2, v_peso NUMBER, v_alcance NUMBER, v_capacidad NUMBER, v_rareza CHAR);
    PROCEDURE subir_vehiculo(v_nombreUsuario varchar2,v_nombreVehiculo VARCHAR2, v_definicion VARCHAR2, v_asiento NUMBER, v_durabilidad NUMBER, v_velocidad NUMBER, v_tipoVehiculo VARCHAR2, v_juego VARCHAR2, v_grupo CHAR, v_daño NUMBER, v_nombreGranada VARCHAR2, v_nombrePotenciador VARCHAR2, v_nombrePersonaje VARCHAR2);
    ...
    PROCEDURE arreglar_vehiculo(v_nombreUsuario varchar2,v_nombreVehiculo VARCHAR2, v_capacidad NUMBER, v_durabilidad NUMBER, v_velocidad NUMBER, v_definicion VARCHAR2, v_juego VARCHAR2, v_grupo CHAR, v_daño NUMBER, v_manejo VARCHAR2, v_peso NUMBER);
    --procedimiento que inserta municion en la base de datos para las armas--
    PROCEDURE fabricar_municion(v_nombreUsuario varchar2,v_nombreArma NUMBER, v_material VARCHAR2, v_calibre NUMBER, v_cargador NUMBER);
    ...
    PROCEDURE cambiar_municion(v_nombreUsuario varchar2,v_nombreArma VARCHAR2, v_material VARCHAR2, v_calibre NUMBER, v_cargador NUMBER);
...
CREATE OR REPLACE PACKAGE BODY PA_CLIENTES AS
    ...
    PROCEDURE partida_modojuegos(v_nombreUsuario VARCHAR2,v_nombre VARCHAR2, v_descripcion VARCHAR2) IS
        ...
        v_idModo VARCHAR2(9);
        v_acreditacion NUMBER(1);
    BEGIN
        select acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 0 THEN
    ...
    BEGIN
        ...
        if v_acreditacion = 1 THEN
            v_contador := 0;
            SELECT idUsuario into v_idUsuario FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
            SELECT idcampaña INTO v_idCampaña FROM usuarios_campañas
            WHERE idUsuarios = v_idUsuario and campaña = v_nombreCampaña;
    ...
    PROCEDURE nuevo_personaje(v_nombreUsuario VARCHAR2,v_nombreCampaña VARCHAR2,v_nombre VARCHAR2, v_juego VARCHAR2, v_descripcion VARCHAR2, v_desaparecidos CHAR, v_rol VARCHAR2, v_tiposInfectados VARCHAR2, v_rango VARCHAR2, v_especieAlien VARCHAR2) IS
        v_idCampaña VARCHAR2(9);
        v_acreditacion NUMBER(1);
    BEGIN
        select acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 3 THEN
    ...
    --actualiza los datos del personaje en covenant--
    PROCEDURE mejorar_covenant(v_nombreUsuario VARCHAR2,v_nombre VARCHAR2,v_rango VARCHAR2,v_herejes CHAR,v_armadura NUMBER,v_juego VARCHAR2,v_descripcion VARCHAR2,v_rol VARCHAR2,v_desaparecidos CHAR) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion INTO v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 3 THEN
    ...
    --actualiza los datos del personaje en humanos--
    PROCEDURE mejorar_humano(v_nombreUsuario VARCHAR2,v_nombreHumano VARCHAR2,v_rango VARCHAR2,v_juego VARCHAR2,v_descripcion VARCHAR2,v_rol VARCHAR2,v_desaparecidos CHAR) IS
        v_acreditacion NUMBER(1);
    BEGIN
        select acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 3 THEN
    ...
    PROCEDURE generar_mapa(v_nombreUsuario VARCHAR2,v_nombrePersonaje VARCHAR2,v_nombre VARCHAR2,v_descripcion VARCHAR2,v_juego VARCHAR2,v_lugar VARCHAR2,v_bioma VARCHAR2) IS
        v_acreditacion NUMBER(1);
    BEGIN
        select acreditacion into v_acreditacion FROM usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 3 THEN
    ...
    --actualiza los detalles del mapa por su nombre--
    PROCEDURE recargar_mapa(v_nombreUsuario VARCHAR2,v_nombre VARCHAR2,v_descripcion VARCHAR2,v_juego VARCHAR2,v_lugar VARCHAR2,v_bioma VARCHAR2) IS
        v_acreditacion NUMBER(1);
    BEGIN
        select acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 3 THEN
    ...
    PROCEDURE obtener_granada(v_nombreUsuario VARCHAR2,v_nombreGranada VARCHAR2, v_descripcion VARCHAR2, v_alcance NUMBER, v_daño NUMBER, v_acumulado NUMBER) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion INTO v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN 
    ...
    PROCEDURE potenciar_granada(v_nombreUsuario VARCHAR2,v_nombreGranada VARCHAR2, v_descripcion VARCHAR2, v_alcance NUMBER, v_daño NUMBER, v_acumulado NUMBER) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE usar_potenciador(v_nombreUsuario varchar2,v_nombrePotenciador VARCHAR2, v_descripcion VARCHAR2, v_grupo CHAR, v_durabilidad NUMBER) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE mejorar_potenciador(v_nombreUsuario VARCHAR2,v_nombrePotenciador VARCHAR2, v_descripcion VARCHAR2, v_durabilidad NUMBER) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    --crear un arma--
    PROCEDURE recolectar_arma(v_nombreUsuario VARCHAR2,v_idMunicion VARCHAR2,v_nombreArma VARCHAR2, v_tipoArma VARCHAR2, v_definicion VARCHAR2, v_juego VARCHAR2, v_grupo CHAR, v_daño NUMBER, v_nombreGranada VARCHAR2, v_nombrePotenciador VARCHAR2, v_nombrePersonaje VARCHAR2) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE potenciar_arma(v_nombreUsuario VARCHAR2,v_nombreArma VARCHAR2, v_definicion VARCHAR2, v_juego VARCHAR2, v_daño NUMBER, v_manejo VARCHAR2, v_peso NUMBER, v_alcance NUMBER, v_capacidad NUMBER, v_rareza CHAR) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE subir_vehiculo(v_nombreUsuario varchar2,v_nombreVehiculo VARCHAR2, v_definicion VARCHAR2, v_asiento NUMBER, v_durabilidad NUMBER, v_velocidad NUMBER, v_tipoVehiculo VARCHAR2, v_juego VARCHAR2, v_grupo CHAR, v_daño NUMBER, v_nombreGranada VARCHAR2, v_nombrePotenciador VARCHAR2, v_nombrePersonaje VARCHAR2) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE arreglar_vehiculo(v_nombreUsuario varchar2,v_nombreVehiculo VARCHAR2, v_capacidad NUMBER, v_durabilidad NUMBER, v_velocidad NUMBER, v_definicion VARCHAR2, v_juego VARCHAR2, v_grupo CHAR, v_daño NUMBER, v_manejo VARCHAR2, v_peso NUMBER) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE fabricar_municion(v_nombreUsuario varchar2,v_nombreArma NUMBER, v_material VARCHAR2, v_calibre NUMBER, v_cargador NUMBER) IS
        v_acreditacion NUMBER(1);
    BEGIN
        SELECT acreditacion into v_acreditacion FROM Usuarios WHERE nombreUsuario = v_nombreUsuario;
        if v_acreditacion = 5 THEN
    ...
    PROCEDURE cambiar_municion(v_nombreUsuario varchar2,v_nombreArma VARCHAR2, v_material VARCHAR2, v_calibre NUMBER, v_cargador NUMBER) IS
